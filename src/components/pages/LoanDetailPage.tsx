...
import { ArrowLeft, Check, Star, Phone, Calculator, FileText, Users, Shield, Clock, Award } from 'lucide-react';
      ...
      <div className="min-h-screen bg-gray-50 py-12">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="mb-8">
            ...
            <h1 className="text-3xl font-bold text-gray-900 mb-2">Apply for {loan.title}</h1>
            <p className="text-lg text-gray-600">Complete the application below to get started</p>
          </div>
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-r from-navy-900 to-primary-900 text-white py-16">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <Button variant="outline" onClick={onBack} className="mb-6 border-white text-white hover:bg-white hover:text-navy-900">
            <ArrowLeft className="w-4 h-4 mr-2" />
            Back to All Loans
          </Button>
