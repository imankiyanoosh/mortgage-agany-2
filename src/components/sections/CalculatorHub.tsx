...
import { Calculator, TrendingUp, ArrowRight, DollarSign, Percent, Home, CreditCard, PiggyBank, Building, Sparkles, Star, Phone, Calendar } from 'lucide-react';
...
const CalculatorHub: React.FC = () => {
  ...
  const calculatorGridRef = useRef<HTMLDivElement>(null);
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <div className="flex items-center justify-center mb-4">
            ...
            <span className="px-4 py-2 bg-white/10 backdrop-blur-sm text-primary-800 text-sm font-medium rounded-full">
          ...
          <div className="grid lg:grid-cols-2 gap-8 items-center">
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6">
              ...
              <ul className="space-y-3 text-gray-300">
                ...
                <li className="flex items-center">
                  <Calculator className="w-4 h-4 text-blue-400 mr-3" />
